...
public class TpaDeclineCommand implements SimpleCommand {

    private final RTPLink plugin;

    public TpaDeclineCommand(RTPLink plugin) {
        this.plugin = plugin;
    }
    ...
    public void execute(Invocation invocation) {
        ...
        plugin.getTpaManager().handleTpaResponse(request.requestId, false);
        player.sendMessage(plugin.getMessageManager().component("tpa-declined", request.senderName));
    }
}
